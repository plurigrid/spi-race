...
// Triad-colored SPI: identical math to libspi.zig.
// TRIAD_SEED is injected via -Dtriad_seed=0xNNNNNN build option.
// The dylib is named lib<hex>.dylib where <hex> = triad XOR color.
//
// Involution: a ^ a = 0. Apply the triad twice, arrive at origin.

const build_opts = @import("build_options");
const TRIAD_SEED: u64 = if (@hasDecl(build_opts, "triad_seed")) build_opts.triad_seed else 0;
...
const WorkerCtx = struct { seed: u64, start: u64, count: u64, result: u64 = 0 };
